...
/// </summary>
public class getCertificate : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private DevExpress.XtraReports.Parameters.Parameter eServiceId;
    ...
    private void getCertificate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
    {
        ((XtraReport)sender).FilterString = "[eServiceID] =" + ((DXWebMRCS.Models.eService)(System.Web.HttpContext.Current.Session["eservice"])).eServiceID + " And [UserId]=" + ((DXWebMRCS.Models.eService)(System.Web.HttpContext.Current.Session["eservice"])).UserId;
        //+"AND Userid=" + ((DXWebMRCS.Models.eService)(System.Web.HttpContext.Current.Session["eservice"])).UserId;
    }
}
